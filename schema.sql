...
CREATE DATABASE vet_clinic WITH OWNER = postgres ENCODING = 'UTF8' LC_COLLATE = 'English_United States.1252' LC_CTYPE = 'English_United States.1252' TABLESPACE = pg_default CONNECTION
LIMIT
  = -1 IS_TEMPLATE = False;
...
CREATE INDEX idx_visits_date_of_visit ON visits(date_of_visit);
CREATE INDEX idx_visits_animal_id_vet_id ON visits(animal_id, vet_id);
